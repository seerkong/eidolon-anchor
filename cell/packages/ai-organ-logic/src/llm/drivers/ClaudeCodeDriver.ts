...
export function buildClaudeCodeProviderDriver(): ProviderDriverDefinition {
  return {
    name: "claude-code",
    adapterNames: ["claude-code", "claude_code", "claude"],
    ...
    async createStream(params: ProviderDriverStreamParams) {
      const adapter = new ClaudeNodejsFetchLlmAdapter({
