...
import primaryAgentMd from "./primary/AGENT.md" with { type: "text" };
import primaryIdentityMd from "./primary/IDENTITY.md" with { type: "text" };
import primaryRoutingMd from "./primary/ROUTING.md" with { type: "text" };
import codeAgentMd from "./code/AGENT.md" with { type: "text" };
import codeIdentityMd from "./code/IDENTITY.md" with { type: "text" };
import codeRoutingMd from "./code/ROUTING.md" with { type: "text" };
import explorerAgentMd from "./explorer/AGENT.md" with { type: "text" };
import explorerIdentityMd from "./explorer/IDENTITY.md" with { type: "text" };
import explorerRoutingMd from "./explorer/ROUTING.md" with { type: "text" };
import librarianAgentMd from "./librarian/AGENT.md" with { type: "text" };
import librarianIdentityMd from "./librarian/IDENTITY.md" with { type: "text" };
import librarianRoutingMd from "./librarian/ROUTING.md" with { type: "text" };
import oracleAgentMd from "./oracle/AGENT.md" with { type: "text" };
import oracleIdentityMd from "./oracle/IDENTITY.md" with { type: "text" };
import oracleRoutingMd from "./oracle/ROUTING.md" with { type: "text" };
import designerAgentMd from "./designer/AGENT.md" with { type: "text" };
import designerIdentityMd from "./designer/IDENTITY.md" with { type: "text" };
import designerRoutingMd from "./designer/ROUTING.md" with { type: "text" };
...
function renderTemplate(text: string, context?: { workDir?: string }): string {
  return text
    .split("{workdir}").join(context?.workDir ?? "")
    .split("{workDir}").join(context?.workDir ?? "");
}
