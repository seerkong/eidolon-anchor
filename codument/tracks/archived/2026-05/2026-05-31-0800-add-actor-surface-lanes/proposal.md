...
- 受影响的代码区域：
  ...
  - `terminal/packages/tui/src/app/tui_a1/view.tsx`
  - `terminal/packages/tui/src/app/tui_a1/system/**`
  - actor/fiber orchestration and VM projection packages under `cell/` and `terminal/packages/organ`
