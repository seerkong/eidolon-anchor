...
usage() {
  cat <<'EOF'
Build the Eidolon TUI binary and link it to a user-facing command.
...
printf 'Building Eidolon TUI binary via bun...\n'
...
bun run scripts/install-dist-tui.ts --target-path "${link_path}"
